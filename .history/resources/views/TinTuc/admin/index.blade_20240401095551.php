                ...
                <tr>
                    ...
                    <td style="justify-content: center;" class="d-flex aligh-items-center gap-3">
                        <button class="rounded border bg-transparent">
                            <a href="{{route('tintucs.show', ['tintuc'=>$item->MaTinTuc])}}" class="d-flex align-items-center gap-1 px-2 text-black">
                        ...
                        <div class="btn-group dropup">
                            <button type="button" class="rounded border bg-transparent p-2" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu px-2">
                                ...
                                <li class="d-flex justify-content-end gap-1 mt-2">
                                    ...
                                    <button class="bg bg-white px-2 border-1 rounded">
                                        Không
                                    </button>
                                </li>
                            </ul>
