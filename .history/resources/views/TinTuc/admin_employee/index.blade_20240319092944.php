...
<<<<<<< HEAD:resources/views/TinTuc/admin_employee/index.blade.php
        <div class="">
                    ...
                    @foreach ($tintucs as $item)
                        <tr>
                            ...
                            <td class="d-flex aligh-items-center gap-3">
                                <button class="rounded bg-transparent border">
                                    <a href="{{ route('tintucs.edit', ['tintuc' => $item->MaTinTuc]) }}"
...
>>>>>>> Module_B:.history/resources/views/TinTuc/admin_employee/index.blade_20240319092944.php

                                <div class="btn-group dropup">
                                    <button type="button" class="btn bg-transparent border dropdown-toggle"
                                    ...
                                    <ul class="dropdown-menu px-2">
                                        ...
                                        <li class="d-flex justify-content-end gap-1 mt-2">
                                            ...
                                            <form action="{{ route('tintucs.destroy', ['tintuc' => $item->MaTinTuc]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class='btn btn-primary'
                                                    style="padding:2px 8px">Có</button>
                                            </form>
                                        </li>
                                    </ul>
                                </div>
