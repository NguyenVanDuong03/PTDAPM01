...
<div class="col-8 col-md-10 ">
    <div class="">
        <div class="fs-4">Loại Đồ Ăn</div>
        <div class="d-flex justify-content-between py-3">
            <div class="d-flex gap-2 px-2 py-1">
            </div>
            <div class="">
                <a href="{{ route('loaidoans.create') }}">
                ...
                <tr>
                    ...
                    <td style="justify-content: center;" class="d-flex aligh-items-center gap-3">
                        <button class="rounded border bg-transparent">
                            <a href="{{ route('loaidoans.edit', ['loaidoan' => $item->MaTheLoai]) }}" class="d-flex align-items-center gap-1 px-2 text-black">
                            ...
                            <ul class="dropdown-menu px-2">
                                ...
                                <li class="d-flex justify-content-end">
                                    <div class='modal-footer'>
                                        ...
                                        <form action="{{route('loaidoans.destroy',['loaidoan'=>$item->MaTheLoai])}}" method="POST">
                                            @csrf
                                            @method('DELETE')
