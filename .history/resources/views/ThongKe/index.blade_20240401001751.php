    ...
    <div class="col-8 col-md-10 px-5">
        ...
        <div class="">
            <div class="d-grid gap-3">
                ...
                <div class=" row d-flex justify-content-between">
                    <div class=" col-12 col-md-6 d-flex flex-column gap-2">
                        ...
                        <input type="date" class="py-1 px-2 rounded border" name="" id="start-day">
                    </div>
                    <div class=" col-12 col-md-6  d-flex flex-column gap-2">
                        <label for="end-day">Đến ngày</label>
                        <input type="date"class="py-1 px-2 rounded border" name="" id="end-day">
                    </div>
                </div>
            </div>
            ...
            <div id="sokhach">
                <div class="">
                    <h5
                        class="border border-1 rounded-2 p-3 my-5 w-25 m-auto d-flex flex-column gap-4 fw-normal text-center">
                        Số khách
                        <span>
                            11112 người
                        </span>
