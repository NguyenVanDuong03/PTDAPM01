            ...
            <form id="findInfoWithDate" action="{{route('thongkes.index')}}" method="get">
                <div class="d-flex gap-3">
                    ...
                    <select name="kieuthongke" id="kieuthongke" class="w-25 border rounded-2">
                        <option value="doanhthu" {{ $request->input('kieuthongke') == 'doanhthu' ? 'selected' : '' }}>Doanh thu</option>
                        <option value="sokhach" {{ $request->input('kieuthongke') == 'sokhach' ? 'selected' : '' }}>Số khách</option>
