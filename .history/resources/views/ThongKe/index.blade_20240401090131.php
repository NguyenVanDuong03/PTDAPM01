            ...
            <form id="findInfoWithDate" action="{{route('thongkes.index')}}" method="get">
                <div class="d-flex gap-3">
                    ...
                    <select name="kieuthongke" id="kieuthongke" class="w-25 border rounded-2">
                        <option onchange="checkAndSubmitForm()" value="doanhthu" {{ $request->input('kieuthongke') == 'doanhthu' ? 'selected' : '' }}>Doanh thu</option>
                        <option onchange="checkAndSubmitForm()" value="sokhach" {{ $request->input('kieuthongke') == 'sokhach' ? 'selected' : '' }}>Số khách</option>
                        <!-- <option value="tylebanve" {{ $request->input('kieuthongke') == 'tylebanve' ? 'selected' : '' }}>Tỷ lệ bán vé</option> -->
                    </select>
                ...
                <div class=" row d-flex justify-content-between">
                    ...
                    <div class=" col-12 col-md-6 d-flex flex-column gap-2">
                        ...
                        <input value="{{$start_day}}" type="date" class="py-1 px-2 rounded border" name="start_day" id="start-day" onchange="checkAndSubmitForm()">
                    </div>
                    <div class=" col-12 col-md-6  d-flex flex-column gap-2">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        //
        const valueData = [1000, 2000, 3000, 4000, 5000, 6000, 7000];
        const timeData = ['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7'];
