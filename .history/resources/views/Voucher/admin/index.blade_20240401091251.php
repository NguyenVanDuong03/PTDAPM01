                ...
                <tr>
                    ...
                    <td class="d-flex aligh-items-center gap-3">
                        ...
                        <div class="btn-group dropup">
                            <button type="button" class="btn bg-transparent border dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu px-2">
                                ...
                                <li class="d-flex justify-content-end gap-1 mt-2">
                                    <button class="bg-secondary px-1 border-0 text-white rounded" style="padding:2px 8px">
                                        Không
                                    </button>
                                    <form action="{{ route('vouchers.destroy', ['voucher' => $item->MaVoucher]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class='btn btn-primary text-white' style="padding:2px 8px">Có</button>
                                    </form>
                                </li>
                            </ul>
                        </div>
