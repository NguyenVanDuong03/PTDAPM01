...
Route::resource('thongkes', ThongKeController:cl)
...
// route lich-chieu
Route::resource('lichchieus', LichChieuController::class);
...
Route::post('/lichchieus/create/form', [LichChieuController::class, 'create_form'])->name('lichchieus.create_form'); 
Route::get('/lichchieus/create/form', [LichChieuController::class, 'create_form'])->name('lichchieus.create_form'); 
