...
class DoAnController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'CheckIn' => ['required', 'date', 'before_or_equal:now'],
        ], [
            'CustomerName.required' => 'Vui lòng điền đầy đủ tên khách hàng',
            'CustomerName.max' => 'Tên khách hàng vượt quá số kí tự quy định',
            'Identification.required' => 'Vui lòng điền CCCD',
            'Identification.max' => 'Số CCCD không hợp lệ',
            'CheckIn.required' => 'Vui lòng chọn ngày đặt phòng',
            'CheckIn.before_or_equal' => 'Thời gian nhận phòng phải trước thời gian hiện tại',
        ...
        $validator = Validator::make($request->all(), [
            ...
            'TenDoAn.required'=>'Vui lòng nhập tên đồ ăn.'
            'Gia.required'=>'Vui lòng nhập tên đồ ăn.'
        ]);
        if ($validator->fails()) {
