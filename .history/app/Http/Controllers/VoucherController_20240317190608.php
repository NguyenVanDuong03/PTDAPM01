...
class VoucherController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'NgayTao' => ['required'],
            'TenDangNhapNV' => ['required', Rule::exists('nhan_viens', 'TenDangNhapNV')->where(function ($query) use ($request) {
                $query->where('TenDangNhapNV', $request->TenDangNhapNV);
            })],
            'TinhTrang' => ['required'],
            'HanDung' => ['required'],
        ], [
            ...
            'TenDangNhapNV.exists' => 'Tên đăng nhập nhân viên không được bỏ trống',
