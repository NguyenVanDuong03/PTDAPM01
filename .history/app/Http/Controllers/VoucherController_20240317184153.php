...
class VoucherController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'TiLeChietKhau' => ['required', 'numeric', 'min:0'],
            ...
            'TiLeChietKhau.numeric' => 'Vui lòng nhập đầy đủ thông tin',
            'TiLeChietKhau.min' => 'Vui lòng nhập đầy đủ thông tin',
            'HanMuc.required' => 'Kích thước file ảnh không quá 5MB',
            'NgayTao.required' => 'Giá không được bỏ trống',
            'TinhTrang.required' => 'Vui lòng nhập đầy đủ thông tin',
            'HanDung.required' => 'Vui lòng nhập đầy đủ thông tin',
        ]);
        if ($validator->fails()) {
