...
@section('content')
    ...
    <div class="col-8 col-md-10 ">
        <div class="">
            <div class="fs-4">Thể loại phim</div>
            <div class="d-flex justify-content-between py-3">
                <div class="">
                    <a href="{{ route('theloais.create') }}">
                        ...
                        <tr>
                            ...
                            <td class="d-flex aligh-items-center gap-3">
                                <button class="rounded bg-transparent border">
                                    <a href="{{ route('theloais.edit', $theloai->MaTheLoai) }}"
                        ...
                        <div class="btn-group dropup">
                            ...
                            <ul class="dropdown-menu px-2">
                                ...
                                <li class="d-flex justify-content-end">
                                    ...
                                    <form action="{{ route('theloais.destroy', $theloai->MaTheLoai) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
