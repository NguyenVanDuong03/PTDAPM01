...
@section('content')
    <div class="col-8 col-md-10 ">
        <div class="">
            <div class="fs-4">Phòng chiếu</div>
            <div class="d-flex justify-content-between py-3">

            <div class="">
                <a href="{{route('phongchieus.create')}}">
                ...
                <tr>
                    ...
                    <td style="justify-content:center ;" class="d-flex aligh-items-center gap-3">
                        <button class="rounded p-2">
                            <a href="{{route('phongchieus.edit',['phongchieu'=>$item->MaPhong])}}" class="d-flex align-items-center gap-1 px-2 text-black">
                        ...
                        <div class="btn-group dropup">
                            <button type="button" class="rounded p-2" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu px-2">
                                ...
                                <li class="d-flex justify-content-end gap-1 mt-2">
                                    ...
                                    <form action="{{route('phongchieus.destroy',['phongchieu'=>$item->MaPhong])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
