                            ...
                            <ul class="dropdown-menu px-2">
                                ...
                                <li class="d-flex justify-content-end gap-2 mt-2">
                                    <form action="{{ route('vouchers.destroy', ['voucher' => $item->MaVoucher]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class='bg bg-white p-1 border-1 rounded px-2' style="padding:2px 8px">Có</button>
                                    </form>
                                    <button class="bg bg-white px-2 border-1 rounded" style="padding:2px 8px">
                                        Không
                                    </button>
                                </li>
                            </ul>
