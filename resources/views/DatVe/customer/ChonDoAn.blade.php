    ...
    <main class="bg-color">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6 container">
                                    <img src="{{ asset("$DoAn->Anh") }}" class="card-img-top rounded rounded-2" width="200" height="150"
                                    ...
                                    <div>
                                        ...
                                        <div class="quantity-container">
                                            ...
                                            <input type="button" value="-" class="quantity-btn px-2"
                                                ...
                                                onclick="decreaseValue({{ $IndexOfDoAn }}, {{ $DoAn->getGiaDoAn() }})">
                                            <input type="text" class="quantity-input text-center" style="width: 10%;"
                                                value="0" min="0" name="SoLuong[]"
                                                id="total-food{{ $IndexOfDoAn }}" oninput="validateNumber(this)">
                                            <input type="button" value="+" class="quantity-btn px-2"
        ...
        <div class="d-flex gap-2 align-items-center justify-content-between mt-5 text-white px-3 py-2"
            ...
            <div class=" d-flex gap-3">
                <img src="{{asset("$Phim->DuongDan")}}" style="max-width: 120px; margin-right:10px" alt="" class="rounded">
