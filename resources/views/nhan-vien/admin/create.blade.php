...
@section('content')
    <div class="col-8 col-md-10">
        ...
        <form method="post" action="{{route('nhanviens.store')}}" class="d-grid gap-3 w-md-50 mx-auto">
            @csrf
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <input type="text" id="ten-nv" name="TenNhanVien" placeholder="Nhập họ tên của nhân viên"
                    class="py-1 px-2 rounded border border-1"  value="{{old('TenNhanVien')}}">
            ...
            <div class="row">
                <div class="d-flex flex-column gap-2 col-12 col-sm-6">
                    ...
                    <input  value="{{old('NgaySinh')}}" type="date" id="ngay-sinh" name="NgaySinh" class="py-1 px-2 rounded border border-1">
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <input value="{{old('DiaChi')}}" type="text" id="dia-chi" name="DiaChi" class="py-1 px-2 rounded border border-1">
            ...
            <div class="row">
                <div class="d-flex flex-column gap-2 col-12 col-sm-6">
                    ...
                    <input  value="{{old('NgayVaoLam')}}" type="date" id="ngay-vao-lam" name="NgayVaoLam" class="py-1 px-2 rounded border border-1">
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <input  value="{{old('SDT')}}" type="tel" id="so-dien-thoai" name="SDT" class="py-1 px-2 rounded border border-1">
                @if ($errors->has('SDT'))
