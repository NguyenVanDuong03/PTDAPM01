    ...
    <form action="" class="d-grid gap-3 w-md-50 mx-auto">
        <div class="row">
            ...
            <div class="col-3 flex-column d-flex gap-2">
                <label for="ten-do-an" class="">Mã đồ ăn*</label>
                <input value="{{$doan->MaDoAn}}" type="text" id="ten-do-an" class="py-1 px-2 rounded border border-1" placeholder="Nhập tên đồ ăn" disabled="true">
            </div>
            <div class="col-3 flex-column d-flex gap-2">
