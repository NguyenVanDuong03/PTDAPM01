...
<div class="col-8 col-md-10 ">
    <div class="">
        <div class="fs-4">Nhà cung cấp</div>
        <div class="d-flex justify-content-between py-3">
            <div class="">
                <a href="{{ route('nhacungcaps.create') }}">
                ...
                <tr>
                    ...
                    <td class="d-flex aligh-items-center gap-3">
                        <button class="rounded">
                            <a href="{{ route('nhacungcaps.edit', $nhacungcap->MaNCC) }}"
                                ...
                                <div class="btn-group dropup">
                                    <button type="button" class="btn border bg-transparent dropdown-toggle"
                                    ...
                                    <ul class="dropdown-menu px-2">
                                        ...
                                        <li class="d-flex justify-content-end">
                                            ...
                                            <form action="{{ route('nhacungcaps.destroy', $nhacungcap->MaNCC) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="bg-primary px-1 border-0 rounded text-white"
                                                    style="padding:2px 8px">Xóa</button>
                                            </form>
                                        </li>
                                    </ul>
                                </div>
