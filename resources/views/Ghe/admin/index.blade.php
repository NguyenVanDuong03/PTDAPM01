...
@section('content')
    <div class="col-8 col-md-10 ">
        <div class="">
            <div class="fs-4">Loại ghế</div>
            <div class="d-flex justify-content-between py-3">

                <div class="">
                    <a href="{{ route('ghengois.create') }}">
                        ...
                        <tr>
                            ...
                            <td class="d-flex aligh-items-center gap-3">
                                ...
                                <div class="btn-group dropup">
                                    <button type="button" class="btn btn-secondary dropdown-toggle border"
                                    ...
                                    <ul class="dropdown-menu px-2">
                                        ...
                                        <li class="d-flex justify-content-end gap-1 mt-2">
                                            <button style="padding:2px 8px"
                                                class="bg-secondary px-1 border-0 text-white rounded">
                                                Không
                                            </button>
                                            <form action="{{ route('ghengois.destroy', $item->MaGhe) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
