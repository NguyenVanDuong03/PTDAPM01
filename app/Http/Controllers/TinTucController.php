...
class TinTucController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'NgayDang' => ['required', 'before_or_equal:today'],
            'TenDangNhapNV' => ['required'],
            'Anh' => ['max:20480', 'mimes:jpg,png,gif'],
            'NoiDung' => ['required', 'min:50', 'regex:/^[\p{L}\p{N}\s]+$/u'],
        ], [
            'TenSuKien.required' => 'Tên tin tức không được bỏ trống',
            'TenSuKien.max' => 'Tên tin tức không quá 255 ký tự',
            'TenSuKien.regex' => 'Tên tin tức không chứa ký tự đặc biệt',
            'MaLoaiTinTuc.required' => 'Loại tin tức không được để trống',
            'TomTat.required' => 'Tóm tắt không được bỏ trống',
            'TomTat.max' => 'Tóm tắt không quá 500 ký tự',
            'TomTat.regex' => 'Tóm tắt không chứa ký tự đặc biệt',
            'NgayDang.required' => 'Ngày đăng không được bỏ trống',
            'NgayDang.before_or_equal' => 'Ngày đăng không vượt quá ngày hiện tại',
            'NoiDung.required' => 'Nội dung tin tức không được bỏ trống',
            'NoiDung.regex' => 'Nội dung tin tức không chứa ký tự đặc biệt',
            'NoiDung.min' => 'Nội dung tin tức tối thiểu 50 ký tự',
            'Anh.max' => 'Ảnh không vượt quá 20MB',
            'Anh.mimes' => 'Ảnh phải có định dạng JPG, PNG, GIF',
            'TenDangNhapNV.required' => 'Tên nhân viên không được bỏ trống',
        ]);
        if ($validator->fails()) {
