...
class checkPostingDate extends TestCase
{
    ...
    public function test_PostingDate(): void
    {
    ...
    public function test_PostingDateNull(): void
    {
        $response = $this->call('POST', '/tintucs', [
            'TenSuKien' => 'Anh lkajdf flajdflakjf kkajdf lakjdf ljfla',
            'MaLoaiTinTuc' => '1',
        ...
        $response->assertInvalid(['NgayDang']);
    }

    public function test_PostingDateBeforeOrEqual(): void
    {
        $response = $this->call('POST', '/tintucs', [
            'TenSuKien' => 'Anh lkajdf flajdflakjf kkajdf lakjdf ljfla',
            'MaLoaiTinTuc' => '1',
